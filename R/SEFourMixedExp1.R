#A needs to be pass by referenced
SEFourMixedExpA1 <- function(t1, t2, t3, t4, t5, t6, t7, a, sHatSubset) {
  ...
  while (test > criteria & k < maximumIteration) {
    ...
    t13kP <- pow((t1 / (1 + t1)), (3 * k));
    
    A11 <- t5 * (4 * t6 * t6 * t22kP * t3 * t3 * t1P * k * t13P + 16 * t42kP * t6 * t14P * t3 * t1P * t2 - 2 * t42kP * t5 * t5 * t1P * k * k * t3 - 8
                       ...
                       * t2 * t2 * t3 * t3 + 18 * t42kP * t7 * t7 * t2 * t1P * k * t3 * t3 * t1 * t1) * t1aP * t1bP * pow((t7 * t3P + t6 * t2P
  ...
  while (test > Criteria & k < maxIter)
  {
    ...
    a12 <- 1 / (1 + t1) / (1 + t2) / (t7 * t3P + t6 * t2P + t5 * t1P + t4P - t4P * t5 * t1 * t2 * t3 + t5 * t1P * t2 + t6 * t2P * t4 + t6 * t2P
  ...
  while (test > Criteria && k < maxIter)
  {
    ...
    a13 <- 1 / (1 + t1) / (1 + t3) / (t7 * t3P + t6 * t2P + t5 * t1P + t4P - t4P * t5 * t1 * t2 * t3 + t5 * t1P * t2 + t6 * t2P * t4 + t6 * t2P
                                            * t3 + t6 * t2P * t1 + t7 * t3P * t4 + t7 * t3P * t2 + t7 * t3P * t1 - t4P * t6 * t2 - t4P * t7 * t3 - t4P * t5 * t1 + t4P * t2 * t3 - t4P
                                            * t5 * t3 - t4P * t5 * t2 + t4P * t1 * t3 - t4P * t6 * t3 - t4P * t6 * t1 + t4P * t1 * t2 - t4P * t7 * t2 - t4P * t7 * t1 + t5 * t1P * t4
                                            + t5 * t1P * t3 + t4P * t3 - t4P * t5 - t4P * t6 - t4P * t7 + t4P * t2 + t4P * t1 + t5 * t1P * t2 * t4 + t5 * t1P * t3 * t4 + t5 * t1P
                                            * t2 * t3 + t6 * t2P * t1 * t4 + t6 * t2P * t3 * t4 + t6 * t2P * t1 * t3 + t7 * t3P * t2 * t4 + t7 * t3P * t1 * t2 + t7 * t3P * t1 * t4 - t4P
  ...
  while (test > Criteria && k < maxIter)
  {
    ...
    a14 <- -1 / (1 + t1) / (1 + t4) / (t7 * t3P + t6 * t2P + t5 * t1P + t4P - t4P * t5 * t1 * t2 * t3 + t5 * t1P * t2 + t6 * t2P * t4 + t6 * t2P
                                             * t3 + t6 * t2P * t1 + t7 * t3P * t4 + t7 * t3P * t2 + t7 * t3P * t1 - t4P * t6 * t2 - t4P * t7 * t3 - t4P * t5 * t1 + t4P * t2 * t3 - t4P
                                             * t5 * t3 - t4P * t5 * t2 + t4P * t1 * t3 - t4P * t6 * t3 - t4P * t6 * t1 + t4P * t1 * t2 - t4P * t7 * t2 - t4P * t7 * t1 + t5 * t1P * t4
                                             + t5 * t1P * t3 + t4P * t3 - t4P * t5 - t4P * t6 - t4P * t7 + t4P * t2 + t4P * t1 + t5 * t1P * t2 * t4 + t5 * t1P * t3 * t4 + t5 * t1P
                                             * t2 * t3 + t6 * t2P * t1 * t4 + t6 * t2P * t3 * t4 + t6 * t2P * t1 * t3 + t7 * t3P * t2 * t4 + t7 * t3P * t1 * t2 + t7 * t3P * t1 * t4 - t4P
  ...
  while(test > Criteria & k < maxIter)
  {
     ...
     a15 <- 1 / (1 + t1) * pow(t7 * t3P + t6 * t2P + t5 * t1P + t4P - t4P * t5 * t1 * t2 * t3 + t5 * t1P * t2 + t6 * t2P * t4 + t6 * t2P
                                         * t3 + t6 * t2P * t1 + t7 * t3P * t4 + t7 * t3P * t2 + t7 * t3P * t1 - t4P * t6 * t2 - t4P * t7 * t3 - t4P * t5 * t1 + t4P * t2 * t3 - t4P
                                         * t5 * t3 - t4P * t5 * t2 + t4P * t1 * t3 - t4P * t6 * t3 - t4P * t6 * t1 + t4P * t1 * t2 - t4P * t7 * t2 - t4P * t7 * t1 + t5 * t1P * t4
                                         + t5 * t1P * t3 + t4P * t3 - t4P * t5 - t4P * t6 - t4P * t7 + t4P * t2 + t4P * t1 + t5 * t1P * t2 * t4 + t5 * t1P * t3 * t4 + t5 * t1P
                                         * t2 * t3 + t6 * t2P * t1 * t4 + t6 * t2P * t3 * t4 + t6 * t2P * t1 * t3 + t7 * t3P * t2 * t4 + t7 * t3P * t1 * t2 + t7 * t3P * t1 * t4 - t4P
  ...
  while (test > Criteria && k < maxIter)
  {
    ...
    a16 <- -(1 + t3) * t5 * t1P * (-k * t2P - k * t2P * t4 + t4P * k + t4P * k * t2 + t2P * t1 + t2P * t1 * t4 - t4P * t1 - t4P * t1 * t2) / (1
  ...
  while (test > Criteria && k < maxIter)
  {
    ...
    a17 <- -(1 + t2) * t5 * t1P * (-k * t3P - k * t3P * t4 + t4P * k + t4P * k * t3 + t3P * t1 + t3P * t1 * t4 - t4P * t1 - t4P * t1 * t3) / (1
