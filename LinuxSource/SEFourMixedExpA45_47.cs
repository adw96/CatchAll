...
public class SEFourMixedExp5
{
	//*********************************************************************
    //**           Calculate A45 for SE 4 Mixed Exp                     ***
    //*********************************************************************
    public static void SEFourMixedExpA45_47(double t1, double t2, double t3,
        ...
        ref int iterFlag)
    {
        ...
        do
        {
            ...
            double A45 = (-t6*t2P*t3*t3*t4P*t1P*(t4*t4)-2*t6*t2P*t3*t4P*t1P*(t4*t4)*t1+t6*t2P*(t1*t1)*t42kP*t4
				...
				*t1+2*t42kP*(t2*t2)*t3*t3*t7*t1P*t4*t1+t6*t2P*t4P*t7*t1P*(t4*t4))/(1+t4)/t4*Math.Pow(t7*t3P
		...
		do
		{
            ...
            double A46 = -1/(1+t4)/t4*Math.Pow(t7*t3P+t6*t2P+t5*t1P+t4P-t4P*t5*t1*t2*t3+t5*t1P*t2+t6*t2P*t4+t6*t2P
		...
		do
		{
            ...
            double A47 = -1/(1+t4)/t4*Math.Pow(t7*t3P+t6*t2P+t5*t1P+t4P-t4P*t5*t1*t2*t3+t5*t1P*t2+t6*t2P*t4+t6*t2P
				*t3+t6*t2P*t1+t7*t3P*t4+t7*t3P*t2+t7*t3P*t1-t4P*t6*t2-t4P*t7*t3-t4P*t5*t1+t4P*t2*t3-t4P
				*t5*t3-t4P*t5*t2+t4P*t1*t3-t4P*t6*t3-t4P*t6*t1+t4P*t1*t2-t4P*t7*t2-t4P*t7*t1+t5*t1P*t4
				+t5*t1P*t3+t4P*t3-t4P*t5-t4P*t6-t4P*t7+t4P*t2+t4P*t1+t5*t1P*t2*t4+t5*t1P*t3*t4+t5*t1P
				*t2*t3+t6*t2P*t1*t4+t6*t2P*t3*t4+t6*t2P*t1*t3+t7*t3P*t2*t4+t7*t3P*t1*t2+t7*t3P*t1*t4-t4P
